...
class SettingsDialog(QDialog):
    def __init__(self, canvas, parent=None):
        ...
        self.main_frame.setStyleSheet("""
            ...
            QKeySequenceEdit, QSpinBox { background: #f8f9fa; color: black; padding: 8px; border-radius: 8px; border: 1px solid #ccc; }
            QCheckBox { color: #1e1e1e; font-weight: 500; }
        """)
        ...
        title.setStyleSheet("font-size: 24px; color: #6965db; font-weight: 800;")
        close_btn = QPushButton("✕")
        close_btn.setFixedSize(36, 36)
        close_btn.setCursor(Qt.PointingHandCursor)
        close_btn.setStyleSheet("background: #ffefef; color: #ff5f5f; border-radius: 18px; font-weight: bold; border: none; font-size: 18px;")
        ...
        self.theme_combo.addItems(["Light", "Dark", "Charcoal", "Deep Blue", "Colorful", "Jellyfish"])
    ...
    def save_and_close(self):
        ...
        self.canvas.current_theme = self.theme_combo.currentText()
        self.accept()